...
const POPULAR_WORD_MODULE_SOURCES = [
    new URL("./node_modules/popular-english-words/index.js", window.location.href).href,
    "https://unpkg.com/popular-english-words@1.0.2/index.js",
];
const POPULAR_WORD_LIMIT = 20000;

// The arrays below (CORE_4_LETTER_WORDS etc.) are dead code — no longer read by the game.
// Dictionary is loaded exclusively from popular-english-words/words.js.




const CORE_4_LETTER_WORDS = [
    ...
    "edge","else","even","ever","evil","exit","face","fact","fair","fall",
    ...
    "hunt","hurt","idea","inch","into","iron","item","jack","join","joke",
    "jump","just","keep","kept","kick","kill","kind","king","knee","knew",
    ...
    "mate","math","meal","mean","meat","meet","menu","mere","mike","mile",
    "milk","mill","mind","mine","miss","mode","mood","moon","more","most",
    "move","much","must","name","navy","near","neck","need","news","next",
    "nice","nine","none","nose","note","okay","once","only","onto","open",
    "oral","over","pace","pack","page","paid","pain","pair","palm","park",
    "part","pass","past","path","peak","pick","pile","pink","pipe","plan",
    ...
    "safe","said","sale","salt","same","sand","save","seat","seed","seek",
    ...
    "tale","talk","tall","tank","tape","task","team","tell","tent","term",
    "test","text","than","that","them","then","they","thin","this","thus",
    "tick","tide","till","time","tiny","told","toll","tone","tony","took",
    ...
    "wish","with","wood","word","work","yard","yeah","year","your","zero"
];

const MORE_CORE_4_LETTER_WORDS = [
    "abov","ache","acre","acts","afar","afro","aide","aids","ails","aims",
    "airs","ajar","akin","alas","ally","alms","aloe","alto","amid","ammo",
    "anon","ante","ants","apes","apex","arch","ares","arid","arks","arms",
    "arts","asap","ashy","asia","asks","atom","aunt","aura","auto","aver",
    "avid","axes","axis","axle","baas","babe","back","bade","bags","bail",
    "bait","bake","bald","balm","bang","barb","bard","bare","bark","barn",
    "bars","bash","bask","bass","bats","bead","beak","beam","bean","beds",
    "beef","beep","bees","begs","bend","bent","best","beta","bets","bevy",
    "bias","bibs","bide","bigs","bike","bile","bind","bins","bios","bite",
    "bits","blab","blam","bled","blew","blip","blob","bloc","blot","blur",
    "boar","boas","boat","bobs","bode","bogs","boil","bold","bolt","boon",
    "boor","boot","bore","born","boss","bots","bout","bows","boyo","boys",
    "brad","brae","brag","bran","bras","brat","bray","bred","brew","brig",
    "brim","brow","buck","buds","buff","bugs","bulb","bull","bump","bung",
    "bunk","buns","bunt","buoy","burg","burl","burn","burp","burr","bury",
    "bust","buts","buys","buzz","byte","cabs","cafe","cage","cake","calf",
    "cane","cans","cape","caps","carb","care","carp","cars","cart","case",
    "cast","cats","cave","cavy","cede","cell","cent","chad","chap","char",
    "chef","chew","chin","chip","chop","chow","chug","chum","cite","clad",
    "clam","clan","clap","claw","clay","clef","clip","clod","clog","clop",
    "clot","clue","coax","cobs","cock","coda","code","cods","coed","cogs",
    "coif","coil","coin","cola","cols","colt","comb","cone","conk","cons",
    "cook","cool","coon","coop","coot","cops","cord","core","cork","corm",
    "corn","cost","cosy","cote","cots","coup","cove","cowl","cows","cozy",
    "crab","crag","cram","crew","crib","crit","crop","crow","crud","crux",
    "cube","cubs","cuds","cued","cues","cuff","cult","cups","curb","curd",
    "cure","curl","curt","cusp","cuss","cute","cuts","cyan","cyst","czar",
    "dabs","dace","dada","dado","dads","daft","dais","dale","dame","damn",
    "damp","dams","dang","dank","dare","dark","dart","dash","data","date",
    "daub","dawn","days","daze","dead","deaf","deal","dean","dear","debt",
    "deck","deco","deed","deem","deep","deer","deft","defy","deli","dell",
    "demo","dens","dent","deny","deps","desk","devi","devo","dews","dewy",
    "dhow","dial","dice","dick","died","dies","diet","digs","dike","dill",
    "dime","dims","dine","ding","dink","dino","dint","dips","dire","dirt",
    "disc","dish","disk","diva","dive","dock","docs","dodo","doer","does",
    "doge","dogs","dojo","dole","doll","dolt","dome","done","dong","dons",
    "doom","door","dope","dork","dorm","dory","dose","dote","dots","dour",
    "dove","down","doze","drab","drag","dram","drat","draw","dray","dree",
    "dreg","drew","drip","drop","drub","drug","drum","dual","dubs","duck",
    "duct","dude","duds","duel","dues","duet","duff","dugs","duke","dull",
    "duly","dumb","dump","dune","dung","dunk","duns","duos","dupe","dura",
    "dusk","dust","duty","dyad","dyed","dyer","dyes","dyne","earl","earn",
    "ears","ease","east","easy","eats","echo","edge","edgy","edit","eels",
    "eerie","eggs","egis","egos","ekes","elan","elks","ells","elms","else"
];

const PART3_CORE_4_LETTER_WORDS = [
    "emit","ends","envy","epic","eras","errs","etch","even","ever","eves",
    "evil","ewer","exam","exit","eyed","eyes","face","fact","fads","fail",
    "fain","fair","fake","fall","fame","fang","fans","fare","farm","faro",
    "fast","fate","fats","faun","fawn","fays","fear","feat","feds","feed",
    "feel","fees","feet","fell","felt","fend","fens","fern","fess","feta",
    "fete","feud","fiat","fibs","fief","fife","figs","file","fill","film",
    "find","fine","fins","fire","firm","fish","fist","fits","five","fixy",
    "fizz","flab","flag","flak","flam","flan","flap","flat","flaw","flax",
    ...
    "fops","ford","fore","fork","form","fort","foul","four","fowl","foxy",
    "frag","frat","fray","free","fret","frog","from","fuel","full","fume",
    "fund","funk","furl","furs","fury","fuse","fuss","fuze","fuzz","gabs",
    "gads","gaff","gage","gags","gain","gait","gala","gale","gall","gals",
    "game","gamp","gams","gang","gaol","gape","gaps","gapy","garb","gars",
    "gash","gasp","gate","gave","gawk","gays","gaze","gear","geed","geek",
    "gels","gelt","gems","gene","gens","gent","germ","gets","ghee","gibe",
    "gift","gigs","gild","gill","gilt","gimp","gins","gird","girl","girt",
    "gist","give","glad","glam","glee","glen","glib","glim","glob","glom",
    "glow","glue","glug","glum","glut","gnat","gnaw","gnus","goad","goal",
    "goat","gobs","gods","goer","goes","gold","golf","gone","gong","good",
    "goof","goon","gore","gory","gosh","gout","gown","grab","grad","gram",
    "gray","gree","grew","grey","grid","grim","grin","grip","grit","grog",
    "grow","grub","guar","guck","guff","gulf","gull","gulp","gums","gunk",
    "guns","guru","gush","gust","guts","guys","gyms","gyps","gyre","gyro",
    "hack","haft","hags","hahs","hail","hair","hake","hale","half","hall",
    "halo","halt","hams","hand","hang","hank","hard","hare","hark","harm",
    "harp","hart","hash","hasp","hast","hate","hath","hats","haul","have",
    "hawk","hays","haze","hazy","head","heal","heap","hear","heat","heck",
    "heed","heel","heft","heir","held","hell","helm","help","hems","hens",
    "herb","herd","here","hero","hern","hers","hewn","hews","hick","hide",
    "hied","hies","high","hike","hill","hilt","hims","hind","hint","hips",
    "hire","hiss","hist","hits","hive","hoar","hoax","hobo","hobs","hock",
    "hods","hoed","hoer","hoes","hogg","hogs","hold","hole","holy","home",
    "homy","hone","honk","hood","hoof","hook","hoop","hoot","hope","hops",
    "horn","hose","host","hots","hour","hove","howl","hows","hubs","huck",
    "hued","hues","huff","huge","hugs","hula","hulk","hull","hump","hums",
    "hung","hunk","hunt","hurl","hurt","hush","husk","huts","hymn","hype",
    "hypo","iamb","ibex","ibis","iced","ices","icon","idea","ides","idle",
    "idly","idol","iffy","ills","imam","imps","inch","info","inks","inky",
    "inns","into","ions","iota","iris","irks","iron","isle","isms","itch",
    "item","java","jaws","jays","jazz","jeep","jeer","jeez","jell","jerk",
    "jest","jets","jibe","jiff","jigs","jilt","jink","jinn","jinx","jive",
    "jobs","jock","jogs","join","joke","joky","jolt","josh","jots","jowl",
    "joys","judo","jugs","jump","junk","jury","just","jute","kale","keel",
    "keen","keep","kegs","kelp","keno","kens","kept","keys","khan","kick",
    "kids","kill","kiln","kilo","kilt","kind","kine","king","kink","kiss"
];

const PART4_CORE_4_LETTER_WORDS = [
    "kite","kith","kits","kiwi","knee","knew","knit","knob","knot","know",
    "kohl","kook","labs","lace","lack","lacy","lads","lady","lags","laid",
    "lain","lair","lake","lama","lamb","lame","lamp","lams","land","lane",
    "lank","laps","lard","lark","lash","lass","last","late","lath","laud",
    "lava","lave","lawn","laws","lays","laze","lazy","lead","leaf","leak",
    "lean","leap","lear","leas","lech","leek","leer","lees","left","legs",
    "leis","lend","lens","lent","less","lest","lets","levy","lewd","liar",
    "libs","lice","lick","lido","lids","lied","lier","lies","lieu","life",
    "lift","like","lilt","lily","limb","lime","limn","limo","limp","line",
    "ling","link","lint","lion","lips","lira","lire","lisp","list","lite",
    "live","load","loaf","loam","loan","lobe","lobs","loch","loci","lock",
    "loco","lode","loft","loge","logo","logs","logy","loin","loll","lone",
    "long","look","loom","loon","loop","loot","lope","lops","lord","lore",
    "lorn","lose","loss","lost","lota","lots","loud","lour","lout","love",
    "lows","luau","lube","luck","ludo","luff","lugs","lull","lulu","lump",
    "luna","lune","lung","lunt","lure","lurk","lush","lust","lute","luvs",
    "lynx","lyre","mace","mach","made","mads","mage","magi","mags","maid",
    "mail","main","make","male","mall","malt","mama","mane","mans","many",
    "maps","mare","mark","marl","mars","mart","mash","mask","mass","mast",
    "mate","math","mats","matt","maul","maut","mawn","maws","maxi","maya",
    "mayo","mays","maze","mazy","mead","meal","mean","meat","meds","meed",
    "meek","meet","mega","meld","melt","memo","mend","meno","menu","meow",
    "mere","merk","mesh","mess","meta","mete","mewl","mews","mica","mice",
    "mick","midi","mids","mien","miff","migg","mike","mild","mile","milk",
    "mill","milo","mils","milt","mime","mind","mine","mini","mink","mint",
    "minx","mire","mirk","miry","miss","mist","mite","mitt","mixt","moan",
    "moat","mobs","mock","mode","mods","moil","mojo","moke","mola","mold",
    "mole","moll","molt","moly","moms","monk","mono","mons","mood","moon",
    "moor","moos","moot","mope","mops","mopy","more","morn","mors","mort",
    "moss","most","mote","moth","mots","mott","moue","move","mown","mows",
    "moxa","much","muck","muds","muff","mugg","mugs","mule","mull","mumm",
    "mump","mums","muon","mura","mure","murk","mush","musk","muss","must",
    "mute","mutt","myth","nabe","nabs","nada","naff","nags","naif","nail",
    "nala","name","nana","nans","napa","nape","naps","narc","nard","nary",
    "nave","navy","nays","near","neat","nebe","neck","need","neem","neep",
    "neif","nene","neon","nerd","ness","nest","nets","nett","neuk","neum",
    "neve","news","newt","next","nibs","nice","nick","nide","nidi","niff",
    "nigh","nill","nils","nims","nine","nipa","nips","nisi","nite","nits",
    "nock","node","nods","noel","noes","nogg","nogs","noil","noir","nolo",
    "nome","noms","none","nook","noon","noop","nope","nori","norm","nose",
    "nosh","nosy","nota","note","nots","noun","nous","nova","nows","nowt",
    "nubs","nude","nuke","null","numb","nuns","nuts","oafs","oaks","oars",
    "oath","oats","obey","obit","oboe","odds","odes","odic","offa","offs",
    "ogle","ogre","ohed","ohia","ohms","oils","oily","oink","okay","okes",
    "okra","olds","oldy","oleo","oles","olio","olla","omen","omer","omit",
    "once","ones","only","onto","onus","onyx","oops","ooze","oozy","opal",
    "open","opts","opus","oral","orbs","orca","orcs","ordo","ores","orgy",
    "orts","oryx","osar","otto","ouch","ouds","ouph","ours","oust","outs",
    "ouzo","oval","oven","over","ovum","owed","owes","owls","owns","owse",
    "oxen","oxes","oyer","oyes","pace","pack","pact","pads","page","paid",
    "pail","pain","pair","pale","pall","palm","pals","pane","pang","pans",
    "pant","papa","paps","para","pare","park","parr","pars","part","pass",
    "past","pate","path","pats","pave","pawl","pawn","paws","pays","peak",
    "peal","pear","peas","peat","peck","pecs","peds","peek","peel","peen",
    "peep","peer","pegs","pehs","pein","peke","pele","pelf","pelt","pend",
    "peni","pens","pent","peon","pepo","peps","pere","peri","perk","perm",
    "perp","pert","perv","peso","pest","pets","pews","phew","phis","phiz",
    "prow","puce","puck","puds","puff","pugs","puja","puke","pula","pule",
    "pull","pulp","puls","puma","pump","punk","puns","punt","puny","pupa",
    "pups","pure","purl","purr","purs","push","puss","puts","putt","pyre",
    "quad","quag","quai","quay","queu","quid","quin","quip","quit","quiz",
    "quod","race","rack","racy","rads","raft","raga","rage","rags","raid",
    "rail","rain","raja","rake","raki","raku","rale","rami","ramp","rams",
    "rang","rani","rank","rant","rape","raps","rapt","rare","rase","rash",
    "rasp","rata","rate","rath","rats","rave","raws","raya","rays","raze",
    "razz","read","real","ream","reap","rear","rebs","reck","recs","redo",
    "reds","reed","reef","reek","reel","rees","reft","refs","reft","regg",
    "rely","rems","rend","reno","rent","repo","repp","reps","resh","rest",
    "rete","rets","revs","rhea","rhos","rhus","rial","rias","ribs","rice",
    "rich","rick","ride","rids","riel","rife","riff","rifs","rift","rigs",
    "rile","rill","rime","rims","rimy","rind","ring","rink","rins","riot",
    "ripe","rips","rise","risk","rite","ritz","riva","rive","road","roam",
    "roan","roar","robe","robs","rock","rocs","rode","rods","roes","roil",
    "role","rolf","roll","romp","roms","rood","roof","rook","room","root",
    "rope","ropy","rose","rosy","rote","roti","rotl","roto","rots","roue",
    "roum","roup","rout","roux","rove","rows","rube","rubs","ruby","ruck",
    "rude","rued","ruer","rues","ruff","ruga","rugs","ruin","rule","rump",
    "rums","rune","rung","runs","runt","ruse","rush","rusk","rust","ruth",
    "ruts","ryas","ryes","ryke","ryot","sabe","sabs","sack","sacs","sade",
    "sadi","safe","saga","sage","sago","sags","sagy","said","sail","sain",
    "sake","saki","sale","salt","same","sand","sane","sang","sank","sans",
    "saps","sari","sark","sash","sass","sate","sati","saul","save","sawn",
    "saws","says","scab","scad","scam","scan","scar","scat","scow","scud",
    "scum","scut","seal","seam","sear","seas","seat","secs","sect","seed",
    "seek","seem","seen","seep","seer","sees","self","sell","semi","send",
    "sent","sera","serf","sets","sett","sewn","sews","sexy","shad","shag",
    "shah","sham","shay","shea","shed","shes","shew","shim","shin","ship",
    "shiv","shmo","shod","shoe","shog","shoo","shop","shot","show","shri",
    "shun","shut","siam","sibs","sick","side","sift","sigh","sign","sike",
    "silk","sill","silo","silt","sine","sing","sinh","sink","sins","sipe",
    "sips","sire","sirs","site","sits","size","sizy","skag","skas","skat",
    "skee","skeg","sken","skep","skew","skid","skim","skin","skip","skis",
    "skit","skua","slab","slag","slam","slap","slat","slav","slaw","slay",
    "sled","slew","slid","slim","slip","slit","slob","sloe","slog","slop",
    "slot","slow","slub","slue","slug","slum","slur","slut","smog","smug",
    "snag","snap","snaw","sned","snib","snig","snip","snit","snob","snog",
    "snot","snow","snub","snug","soak","soap","soar","soas","soba","sobs",
    "sock","soda","sods","sofa","soft","soil","soja","soke","sola","sold",
    "sole","soli","solo","sols","soma","some","song","sons","soon","soot",
    "soph","sops","sorb","sord","sore","sori","sort","soth","sots","souk",
    "soul","soup","sour","sous","sown","sows","soya","soys","spad","spam",
    "span","spar","spas","spat","spay","spec","sped","spew","spin","spit",
    "spiv","spot","spry","spud","spue","spun","spur","stab","stag","star",
    "stay","stem","step","stew","stir","stoa","stob","stop","stot","stow",
    "stub","stud","stum","stun","stye","suba","subs","such","suds","sued",
    "suer","sues","suet","suit","sulk","sumo","sump","sums","sung","sunk",
    "sunn","suns","sups","suq","sure","surf","swab","swag","swam","swan",
    "swap","swat","sway","swig","swim","swiz","swob","swop","swot","swum",
    "syce","syke","sync","syne","tabs","tabu","tace","tach","tack","taco",
    "tact","tads","tags","tahr","tail","tain","taka","take","tala","talc",
    "tale","tali","talk","tall","tame","tamp","tams","tang","tank","tans",
    "tape","taps","tare","tarn","taro","tarp","tars","tart","task","tass",
    "tate","tats","taun","taur","taut","tavs","taws","taxa","taxi","tead",
    "teak","teal","team","tear","teas","teat","tech","tecs","teed","teel",
    "teem","teen","tees","teff","tegu","tela","tele","tell","tels","temp",
    "tend","tens","tent","tepa","term","tern","test","text","than","that",
    "thaw","thee","them","then","thew","they","thin","thio","thir","this",
    "thou","thro","thru","thud","thug","thus","tick","tics","tide","tidy",
    "tied","tier","ties","tiff","tige","tika","tike","tile","till","tilt",
    "time","tine","ting","tink","tins","tint","tiny","tipi","tips","tire",
    "tirl","tiro","titi","tivy","toad","toat","toby","toea","toed","toes",
    "toff","tofu","toga","togs","toil","toit","toke","tola","told","tole",
    "toll","tolt","tomb","tome","toms","tone","tong","tons","tony","took",
    "tool","toom","toon","toot","tope","toph","topi","topo","tops","tora",
    "torc","tore","tori","torn","toro","torr","tors","tort","tory","tosh",
    "toss","tost","tote","tots","tour","tout","town","tows","towy","toyo",
    "toys","trad","tram","trap","tray","tree","tref","trek","trey","trig",
    "trim","trio","trip","trod","trot","trow","troy","true","trug","tuba",
    "tube","tubs","tuck","tufa","tuff","tuft","tugs","tuis","tule","tump",
    "tuna","tune","tung","tuns","tups","turd","turf","turk","turn","tush",
    "tusk","tuts","tutu","twee","twig","twin","twit","twos","tyee","tyer",
    "tyes","tyin","tyke","tyne","type","typo","typy","tyre","tyro","udar",
    "udos","ughs","ugly","ukes","ulan","ulna","ulus","umps","unai","unau",
    "unbe","unci","unco","unde","undo","undy","unit","unto","updo","upas",
    "upgo","upon","urbs","urds","urea","urge","uric","urns","urva","used",
    "user","uses","utas","utes","uvic","uvea","vacs","vagi","vail","vain",
    "vair","vale","vamp","vane","vang","vans","vara","vars","vary","vasa",
    "vase","vast","vats","vatu","vaus","vavs","vaws","veal","veep","veer",
    "vees","veil","vein","vela","veld","vena","vend","vent","vera","verb",
    "vert","very","vest","veto","vets","vext","vial","vibe","vice","vide",
    "vids","vied","vier","vies","view","viga","vigs","vile","vill","vims",
    "vina","vine","vino","viny","viol","vips","visa","vise","vita","viva",
    "vive","vivo","vlei","vlog","voce","void","vole","volt","vote","vows",
    "vrow","vugg","vugh","vugs","wabs","wack","wade","wadi","wads","waes",
    "waft","wage","wags","waif","wail","wain","wair","wait","wake","wale",
    "walk","wall","walt","wand","wane","wang","wank","wans","want","wany",
    "waps","ward","ware","warm","warn","warp","wars","wart","wary","wash",
    "wasp","wast","wats","watt","waul","waur","wave","wavy","wawl","waws",
    "waxy","ways","weak","weal","wean","wear","webs","weds","weed","week",
    "weel","ween","weep","weer","wees","weet","weft","weir","weka","weld",
    "well","welt","wend","wens","went","wept","were","wert","west","wets",
    "wham","whap","what","whee","when","whet","whew","whey","whid","whig",
    "whim","whin","whip","whir","whit","whiz","whoa","whom","whop","whup",
    "whys","wich","wick","wide","wife","wigs","wiki","wild","wile","will",
    "wilt","wily","wimp","wind","wine","wing","wink","wino","wins","winy",
    "wipe","wire","wiry","wise","wish","wisp","wiss","wist","wite","with",
    "wits","wive","woad","woes","woke","woks","wold","wolf","womb","wonk",
    "wons","wont","wood","woof","wool","woos","wops","word","work","worm",
    "worn","wort","wost","wots","wove","wows","wrap","wren","writ","wuss",
    "wynd","wynn","wyns","yack","yads","yaff","yagi","yags","yaks","yald",
    "yams","yang","yank","yaps","yard","yare","yarn","yaud","yauld","yawl",
    "yawn","yawp","yaws","yays","yead","yeah","yean","year","yeas","yeat",
    "yech","yegg","yeld","yelk","yell","yelp","yens","yeps","yerk","yeti",
    "yett","yeuk","yews","yill","yins","yipe","yips","yird","yirk","yirr",
    "ylem","yobs","yock","yodh","yods","yoga","yogh","yogi","yoke","yold",
    "yolk","yond","yoni","yore","your","yous","yowl","yows","yuan","yuca",
    "yuch","yuck","yuga","yuks","yule","yurt","yutz","ywis","zags","zany",
    "zaps","zarf","zeal","zebu","zeds","zees","zein","zeks","zero","zest",
    "zeta","zigs","zinc","zing","zion","ziph","zips","ziti","zits","zoas",
    "zoea","zoic","zona","zone","zonk","zoom","zoon","zoos","zori","zulu"
];

// NOTE: CORE_4_LETTER_WORDS and related arrays below are dead code — the
// dictionary is built exclusively from popular-english-words/words.js.

async function _loadPopularWords() {
    for (const src of POPULAR_WORD_MODULE_SOURCES) {
        const list = await _tryLoadPopularWordsModule(src);
        if (list) return list;
    }
    throw new Error("Unable to load popular-english-words data via getMostPopular");
}

async function _tryLoadPopularWordsModule(src) {
    try {
        const mod = await import(/* webpackIgnore: true */ src);
        if (mod?.words?.getMostPopular) {
            const list = mod.words.getMostPopular(POPULAR_WORD_LIMIT);
            console.log(`Loaded top ${POPULAR_WORD_LIMIT} words via getMostPopular from ${src}.`);
            return list;
        }
    } catch (err) {
        console.warn(`Failed to import popular-english-words module from ${src}`, err);
    }
    return null;
}
...
function _normalizeDictionaryWords(words) {
    ...
    for (const raw of words) {
        if (!raw) continue;
        // Strip apostrophes, dashes, and any non-letter characters so players
        // only need to form letters — e.g. "it's" → "ITS"
...
async function loadDictionary() {
    try {
        const popularWords = await _loadPopularWords();
        const trimmed = popularWords.slice(0, POPULAR_WORD_LIMIT);
        const normalized = _normalizeDictionaryWords(trimmed);
        DICTIONARY = new Set(normalized);
        console.log(`Loaded ${DICTIONARY.size} words from popular-english-words (top ${POPULAR_WORD_LIMIT}).`);
    } catch (err) {
        console.error("Failed to load popular-english-words/words.js; dictionary will be empty.", err);
        DICTIONARY = new Set();
    }
...
// Legacy inline words kept as fallback (used only if fetch fails)
const _FALLBACK_WORDS = [
    // 3-letter words
    "ACE","ACT","ADD","AGE","AGO","AID","AIM","AIR","ALL","AND","ANT","ANY","APE",
    "ARC","ARE","ARK","ARM","ART","ATE","AWE","AXE",
    "BAD","BAG","BAN","BAR","BAT","BED","BET","BIG","BIT","BOW","BOX","BOY","BUD",
    "BUG","BUN","BUS","BUT","BUY",
    "CAB","CAN","CAP","CAR","CAT","COP","COT","COW","CRY","CUB","CUD","CUP","CUT",
    "DAB","DAD","DAM","DAY","DEN","DEW","DID","DIG","DIM","DIP","DOC","DOG","DOT","DRY","DUB","DUE","DUG","DYE",
    "EAR","EAT","EEL","EGG","ELF","ELK","ELM","EMU","END","ERA","EVE","EWE","EYE",
    "FAN","FAR","FAT","FAX","FED","FEW","FIG","FIN","FIT","FIX","FLY","FOB","FOE",
    "FOG","FOP","FOR","FOX","FRY","FUN","FUR",
    "GAB","GAG","GAP","GAS","GAY","GEL","GEM","GET","GIG","GIN","GNU","GOB","GOD",
    ...
    "MAD","MAN","MAP","MAR","MAT","MAW","MAX","MAY","MEN","MET","MID","MIX","MOB",
    "MOD","MOM","MOP","MOW","MUD","MUG","MUM",
    "NAB","NAG","NAP","NET","NEW","NIL","NIT","NOD","NOR","NOT","NOW","NUB","NUN","NUT",
    "OAK","OAR","OAT","ODD","ODE","OFF","OFT","OIL","OLD","ONE","OPT","ORB","ORE","OUR",
    "OUT","OWE","OWL","OWN",
    "PAD","PAL","PAN","PAP","PAT","PAW","PAY","PEA","PEG","PEN","PEP","PER","PET",
    "PIE","PIG","PIN","PIT","PLY","POD","POP","POT","POW","PRY","PUB","PUG","PUN","PUP","PUS","PUT",
    "RAG","RAM","RAN","RAP","RAT","RAW","RAY","RED","REF","RIB","RID","RIG","RIM",
    "RIP","ROB","ROD","ROT","ROW","RUB","RUG","RUM","RUN","RUT","RYE",
    "SAC","SAD","SAG","SAP","SAT","SAW","SAY","SEA","SET","SEW","SHE","SHY","SIN",
    "SIP","SIS","SIT","SIX","SKI","SKY","SLY","SOB","SOD","SON","SOP","SOT","SOW",
    ...
    "WAD","WAG","WAR","WAS","WAX","WAY","WEB","WED","WET","WHO","WIG","WIN","WIT",
    "WOE","WOK","WON","WOO","WOW",
    "YAK","YAM","YAP","YAW","YEA","YES","YET","YEW","YIN","YOU","YOW",
    "ZAP","ZEN","ZIP","ZIT","ZOO",
    // 4-letter words
    "ABLE","ACHE","ACID","ACRE","AGED","ALSO","ARCH","AREA","ARMY","AWAY","AXLE",
    "BACK","BAKE","BALD","BALL","BAND","BANE","BANG","BANK","BARE","BARK","BARN",
    "BASE","BATH","BEAD","BEAK","BEAM","BEAN","BEAR","BEAT","BEEN","BEER","BELL",
    "BELT","BEND","BENT","BEST","BIKE","BILL","BIND","BIRD","BITE","BLOW","BLUE",
    "BLUR","BOAT","BODY","BOLD","BOLT","BOMB","BOND","BONE","BOOK","BOOM","BOOT",
    "BORE","BORN","BOSS","BOTH","BOWL","BULK","BULL","BUMP","BURN","BUSH","BUSY","BUZZ",
    "CAFE","CAGE","CAKE","CALF","CALL","CALM","CAME","CAMP","CAPE","CARD","CARE",
    "CART","CASE","CASH","CAST","CAVE","CHAT","CHIP","CHOP","CITE","CITY","CLAD",
    "CLAM","CLAP","CLAY","CLIP","CLOCK","CLUB","CLUE","COAL","COAT","CODE","COIL",
    "COIN","COLD","COLE","COLT","COMB","COME","CONE","COOK","COOL","COPE","COPY",
    "CORD","CORE","CORK","CORN","COST","COSY","COUP","COVE","CRAB","CREW","CROP",
    "CROW","CUBE","CULT","CURB","CURE","CURL","CUTE",
    "DALE","DAME","DAMP","DARE","DARK","DART","DASH","DATA","DATE","DAWN","DEAD",
    "DEAF","DEAL","DEAR","DEBT","DECK","DEED","DEEM","DEEP","DEER","DEMO","DENT",
    "DENY","DESK","DIAL","DICE","DIET","DIME","DINE","DIRE","DIRT","DISC","DISH",
    "DOCK","DOES","DOME","DONE","DOOM","DOOR","DOSE","DOVE","DOWN","DOZE","DRAG",
    "DRAW","DRIP","DROP","DRUM","DUAL","DUCK","DUEL","DULL","DUMB","DUMP","DUNE",
    "DUSK","DUST","DUTY",
    ...
    "FAST","FATE","FAWN","FEAR","FEAT","FEED","FEEL","FEET","FELL","FELT","FERN",
    "FILE","FILL","FILM","FIND","FINE","FIRE","FIRM","FISH","FIST","FLAG","FLAT",
    "FLAW","FLEA","FLED","FLEW","FLIP","FLOG","FLOW","FOAM","FOIL","FOLD","FOLK",
    "FOND","FONT","FOOD","FOOL","FOOT","FORD","FORE","FORK","FORM","FORT","FOUL",
    "FOUR","FREE","FROG","FROM","FUEL","FULL","FUME","FUND","FURY","FUSE","FUSS",
    "GAIN","GALE","GAME","GANG","GAPE","GARB","GATE","GAVE","GAZE","GEAR","GENE",
    "GIFT","GILD","GIRL","GIVE","GLAD","GLEE","GLEN","GLOW","GLUE","GOAT","GOES",
    "GOLD","GOLF","GONE","GOOD","GORE","GRAB","GRIM","GRIN","GRIP","GRIT","GROW",
    "GULF","GUST","GUTS",
    "HACK","HAIL","HAIR","HALE","HALF","HALL","HALT","HAND","HANG","HARE","HARM",
    "HARP","HASH","HATE","HAUL","HAVE","HAZE","HAZY","HEAD","HEAL","HEAP","HEAR",
    "HEAT","HEED","HEEL","HELD","HELM","HELP","HERB","HERD","HERE","HERO","HIDE",
    "HIGH","HIKE","HILL","HILT","HIND","HINT","HIRE","HOLD","HOLE","HOME","HONE",
    "HOOD","HOOK","HOPE","HORN","HOST","HOUR","HOWL","HUGE","HULL","HUNG","HUNT",
    "HURL","HURT","HUSK","HYMN",
    "ICON","IDEA","IDLE","INCH","INTO","IRON","ISLE","ITEM",
    "JACK","JAIL","JAMB","JAZZ","JERK","JEST","JILT","JINX","JIVE","JOCK","JOIN",
    "JOKE","JOLT","JUMP","JUNE","JUNK","JURY","JUST","JUTE",
    "KALE","KEEN","KEEP","KELP","KEPT","KICK","KILL","KIND","KING","KISS","KITE",
    "KNOB","KNOT","KNOW",
    "LACE","LACK","LAID","LAKE","LAME","LAMP","LAND","LANE","LARD","LARK","LASH",
    "LASS","LAST","LATE","LAWN","LAZY","LEAD","LEAF","LEAK","LEAN","LEAP","LEFT",
    "LEND","LENS","LESS","LIAR","LICE","LICK","LIED","LIFE","LIFT","LIKE","LIMB",
    "LIME","LIMP","LINE","LINK","LINT","LION","LIST","LIVE","LOAD","LOAF","LOAN",
    "LOCK","LOFT","LONE","LONG","LOOK","LOOM","LOOP","LORD","LORE","LOSE","LOSS",
    "LOST","LOTS","LOUD","LOVE","LUCK","LUMP","LUNG","LURE","LURK","LUSH","LUST",
    "MADE","MAGE","MAID","MAIL","MAIN","MAKE","MALE","MALL","MALT","MANE","MANY",
    "MARE","MARK","MASK","MASS","MAST","MATE","MAZE","MEAD","MEAL","MEAN","MEAT",
    "MEET","MELT","MEMO","MEND","MENU","MERE","MESH","MESS","MILD","MILE","MILK",
    "MILL","MIME","MIND","MINE","MINT","MISS","MIST","MODE","MOLD","MOLE","MOLT",
    "MONK","MOOD","MOON","MOOR","MORE","MOSS","MOST","MOTH","MOVE","MUCH","MULE",
    "MUSE","MUST","MUTE",
    "NAIL","NAME","NAVY","NEAR","NEAT","NECK","NEED","NEST","NEWS","NEXT","NICE",
    "NINE","NODE","NONE","NOON","NORM","NOSE","NOTE","NOUN","NOVA",
    "OBEY","ODDS","OGRE","OINK","OKAY","OMEN","OMIT","ONCE","ONLY","ONTO","OPAL",
    "OPEN","ORAL","ORCA","OVEN","OVER","OWED","OXEN",
    "PACE","PACK","PAGE","PAID","PAIL","PAIN","PAIR","PALE","PALM","PANE","PARK",
    "PART","PASS","PAST","PATH","PAVE","PEAK","PEAL","PEAR","PEAT","PEEL","PEER",
    "PELT","PERK","PEST","PICK","PIER","PIKE","PILE","PILL","PINE","PINK","PINT",
    "PIPE","PLAN","PLAY","PLEA","PLOT","PLOW","PLUG","PLUM","PLUS","POEM","POET",
    "POLE","POLL","POLO","POND","POOL","POOR","POPE","PORK","PORT","POSE","POST",
    "POUR","PRAY","PREY","PROP","PULL","PULP","PUMP","PURE","PUSH",
    "QUIT","QUIZ",
    "RACE","RACK","RAFT","RAGE","RAID","RAIL","RAIN","RAKE","RAMP","RANG","RANK",
    "RARE","RASH","RATE","RAVE","READ","REAL","REAP","REAR","REED","REEF","REEL",
    "RELY","RENT","REST","RICH","RIDE","RIFT","RILE","RILL","RIND","RING","RIOT",
    "RISE","RISK","ROAD","ROAM","ROAR","ROBE","ROCK","RODE","ROLE","ROLL","ROOF",
    "ROOM","ROOT","ROPE","ROSE","ROTE","ROVE","RUDE","RUIN","RULE","RUMP","RUNG",
    "RUSH","RUST",
    "SACK","SAFE","SAGE","SAID","SAIL","SAKE","SALE","SALT","SAME","SAND","SANE",
    "SANG","SANK","SAVE","SEAL","SEAM","SEAT","SECT","SEED","SEEK","SEEM","SEEN",
    "SELF","SELL","SEND","SENT","SEWN","SHED","SHIN","SHIP","SHOP","SHOT","SHOW",
    "SHUT","SICK","SIDE","SIFT","SIGH","SIGN","SILK","SILL","SILT","SING","SINK",
    "SITE","SIZE","SKIT","SLAB","SLAG","SLAM","SLAP","SLED","SLID","SLIM","SLIP",
    "SLIT","SLOT","SLOW","SLUG","SMOG","SNAP","SNIP","SNOW","SNUB","SNUG","SOAK",
    "SOAP","SOAR","SOCK","SODA","SOFT","SOIL","SOLD","SOLE","SOME","SONG","SOON",
    "SORE","SORT","SOUL","SOUR","SOWN","SPAN","SPAR","SPEC","SPED","SPIN","SPIT",
    "SPOT","SPUR","STAB","STAG","STAR","STAY","STEM","STEP","STEW","STIR","STOP",
    "STUB","STUD","STUN","SUCH","SUIT","SULK","SUMP","SUNG","SUNK","SURE","SURF",
    "SWAN","SWAP","SWIM",
    "TACK","TACT","TAIL","TAKE","TALE","TALK","TALL","TAME","TANG","TANK","TAPE",
    "TARN","TART","TASK","TAXI","TEAM","TEAR","TELL","TEND","TENS","TENT","TERM",
    "TEST","TEXT","THAN","THAT","THEM","THEN","THEY","THIN","THIS","THUS","TICK",
    "TIDE","TIDY","TIED","TIER","TILE","TILL","TILT","TIME","TINT","TINY","TIRE",
    "TOAD","TOES","TOIL","TOLD","TOLL","TOMB","TONE","TOOK","TOOL","TOPS","TORE",
    "TORN","TORT","TOSS","TOUR","TOWN","TRAP","TRAY","TREE","TREK","TRIM","TRIO",
    "TRIP","TROT","TRUE","TUBE","TUCK","TUFT","TUNA","TUNE","TURN","TWIG","TWIN",
    "TYPE",
    "UGLY","UNDO","UNIT","UNTO","UPON","URGE","USED",
    "VAIN","VALE","VANE","VARY","VASE","VAST","VEIL","VEIN","VENT","VERB","VERY",
    "VEST","VETO","VIEW","VINE","VOID","VOLT","VOTE",
    "WADE","WAGE","WAIL","WAIT","WAKE","WALK","WALL","WAND","WANT","WARD","WARM",
    "WARN","WARP","WART","WARY","WASH","WAVE","WAVY","WAXY","WEAK","WEAN","WEAR",
    "WEED","WEEK","WEEP","WELD","WELL","WENT","WERE","WEST","WHAT","WHEN","WHIM",
    "WHIP","WHOM","WICK","WIDE","WIFE","WILD","WILL","WILT","WILY","WIND","WINE",
    "WING","WINK","WIPE","WIRE","WISE","WISH","WITH","WOKE","WOLF","WOMB","WOOD",
    "WOOL","WORD","WORE","WORK","WORM","WORN","WOVE","WRAP","WREN",
    "YARD","YARN","YEAR","YELL","YOUR",
    "ZEAL","ZERO","ZEST","ZINC","ZONE","ZOOM",
    // 5-letter words
    "ABOUT","ABOVE","ACTOR","ADMIT","ADOPT","AGENT","AGREE","AHEAD","ALARM","ALBUM",
    "ALIEN","ALIGN","ALIKE","ALIVE","ALLEY","ALLOW","ALONE","ALONG","ALTER","AMONG",
    "ANGEL","ANGER","ANGLE","ANGRY","ANIME","ANKLE","APART","APPLE","ARENA","ARGUE",
    "ARISE","ASIDE","ASSET","ATLAS","AVOID","AWAKE","AWARD","AWARE",
    "BADGE","BASIC","BASIN","BASIS","BEACH","BEAST","BEGIN","BEING","BELOW","BENCH",
    "BLACK","BLADE","BLAME","BLAND","BLANK","BLAST","BLAZE","BLEED","BLEND","BLESS",
    "BLIND","BLINK","BLISS","BLOCK","BLOOM","BLOWN","BOARD","BOAST","BONUS","BOOST",
    ...
    "COAST","COLOR","COMET","CORAL","COULD","COUNT","COURT","COVER","CRACK","CRAFT",
    ...
    "DEPTH","DERBY","DEVIL","DINER","DIRTY","DIZZY","DOUBT","DOUGH","DRAFT","DRAIN",
    "DRAKE","DRAMA","DRANK","DRAWN","DREAM","DRESS","DRIED","DRIFT","DRILL","DRINK",
    "DRIVE","DRONE","DROVE","DRUNK","DRYER","DUSTY","DWARF","DWELL",
    "EAGER","EAGLE","EARLY","EARTH","EIGHT","ELDER","ELECT","ELITE","EMPTY","ENEMY",
    "ENJOY","ENTER","EQUAL","ERROR","EVENT","EVERY","EXACT","EXILE","EXIST","EXTRA",
    "FABLE","FACET","FAINT","FAIRY","FAITH","FALSE","FANCY","FATAL","FAULT","FEAST",
    "FENCE","FETCH","FEVER","FIBER","FIELD","FIERY","FIFTY","FIGHT","FINAL","FIRST",
    "FIXED","FLAME","FLARE","FLASH","FLEET","FLESH","FLINT","FLOAT","FLOCK","FLOOD",
    "FLOOR","FLORA","FLOUR","FLUID","FLUKE","FLUSH","FLUTE","FOCUS","FORCE","FORGE",
    "FORTH","FORUM","FOUND","FRAME","FRANK","FRAUD","FRESH","FRONT","FROST","FROZE",
    "FRUIT","FULLY","FUNNY","FUZZY",
    "GHOST","GIANT","GIVEN","GLADE","GLARE","GLASS","GLEAM","GLOBE","GLOOM","GLORY",
    ...
    "HAPPY","HARSH","HASTE","HAVEN","HEART","HEAVY","HEDGE","HENCE","HOBBY","HOMER",
    "HONEY","HONOR","HORSE","HOTEL","HOUSE","HUMAN","HUMOR",
    "IDEAL","IMAGE","IMPLY","INDEX","INNER","INPUT","IRONY","ISSUE","IVORY",
    "JEWEL","JOINT","JOKER","JUDGE","JUICE","JUICY",
    "KNACK","KNEEL","KNIFE","KNOCK","KNOLL","KNOWN",
    "LABEL","LABOR","LARGE","LASER","LATER","LAUGH","LAYER","LEARN","LEASE","LEAST",
    "LEAVE","LEGAL","LEMON","LEVEL","LEVER","LIGHT","LIMIT","LINEN","LIVER","LOCAL",
    "LODGE","LOGIC","LOOSE","LOVER","LOWER","LOYAL","LUNAR","LUNCH",
    "MAGIC","MAJOR","MAKER","MANOR","MAPLE","MARCH","MATCH","MAYOR","MEDAL","MEDIA",
    "MERCY","MERGE","MERIT","METAL","METER","MIGHT","MINOR","MINUS","MODEL","MONEY",
    "MONTH","MORAL","MOTEL","MOTOR","MOUNT","MOUSE","MOUTH","MOVIE","MUDDY","MUSIC",
    "NAIVE","NERVE","NEVER","NIGHT","NOBLE","NOISE","NORTH","NOTED","NOVEL","NURSE",
    "OCEAN","OFFER","OFTEN","OLIVE","ORDER","OTHER","OUTER","OWNER","OXIDE",
    "PAINT","PANEL","PANIC","PAPER","PATCH","PAUSE","PEACE","PEACH","PEARL","PENNY",
    ...
    "PRIZE","PROBE","PRONE","PROOF","PROUD","PROVE","PROXY","PSALM","PULSE","PUNCH","PUPIL",
    ...
    "RISKY","RIVAL","RIVER","ROBIN","ROBOT","ROCKY","ROGER","ROUGE","ROUGH","ROUND",
    "ROUTE","ROYAL","RUGBY","RULER","RURAL",
    "SAINT","SALAD","SALES","SAUCE","SCALE","SCARE","SCENE","SCOPE","SCORE","SCOUT",
    "SENSE","SERVE","SETUP","SEVEN","SHALL","SHAME","SHAPE","SHARE","SHARK","SHARP",
    "SHAVE","SHEEP","SHEER","SHEET","SHELF","SHELL","SHIFT","SHIRE","SHIRT","SHOCK",
    "SHORE","SHORT","SHOUT","SHOVE","SIEGE","SIGHT","SIGMA","SINCE","SIXTH","SIXTY",
    "SKATE","SKILL","SKULL","SLATE","SLAVE","SLEEP","SLICE","SLIDE","SLOPE","SMALL",
    "SMART","SMELL","SMILE","SMITH","SMOKE","SNAKE","SOLAR","SOLID","SOLVE","SORRY",
    "SOUND","SOUTH","SPACE","SPARE","SPEAK","SPEED","SPELL","SPEND","SPICE","SPIKE",
    "SPINE","SPITE","SPOKE","SPOON","SPORT","SPRAY","SQUAD","STACK","STAFF","STAGE",
    "STAIN","STAIR","STAKE","STALE","STALL","STAMP","STAND","STARE","START","STATE",
    "STAYS","STEAK","STEAL","STEAM","STEEL","STEEP","STEER","STERN","STICK","STILL",
    "STING","STOCK","STONE","STOOD","STOOL","STORE","STORM","STORY","STOUT","STOVE",
    "STRAP","STRAW","STRAY","STRIP","STUCK","STUDY","STUFF","STYLE","SUGAR","SUITE",
    "SUNNY","SUPER","SURGE","SWAMP","SWARM","SWEAR","SWEAT","SWEEP","SWEET","SWEPT",
    "SWIFT","SWING","SWIRL","SWORD",
    "TABLE","TASTE","TEACH","TEETH","TEMPO","TENSE","TENTH","THEME","THICK","THIEF",
    "THING","THINK","THIRD","THORN","THREE","THREW","THROW","THUMB","TIGER","TIGHT",
    ...
    "TRUST","TRUTH","TUMOR","TUNER","TWICE","TWIST",
    "ULTRA","UNCLE","UNDER","UNION","UNITE","UNITY","UNTIL","UPPER","UPSET","URBAN",
    "USAGE","USUAL","UTTER",
    "VALID","VALUE","VAULT","VERSE","VIDEO","VIGOR","VINYL","VIRAL","VIRUS","VISIT",
    "VITAL","VIVID","VOCAL","VOICE","VOTER",
    "WAIST","WASTE","WATCH","WATER","WEARY","WEAVE","WEDGE","WEIGH","WEIRD","WHALE",
    "WHEAT","WHEEL","WHERE","WHICH","WHILE","WHITE","WHOLE","WHOSE","WIDTH","WITCH",
    "WOMAN","WORLD","WORRY","WORSE","WORST","WORTH","WOULD","WOUND","WRATH","WRECK",
    "WRITE","WRONG","WROTE",
    "YACHT","YIELD","YOUNG","YOUTH",
    // 6-letter words
    "ABSORB","ACCEPT","ACCESS","ACROSS","ACTION","ACTIVE","ACTUAL","ADMIRE","AFFIRM",
    "AFFORD","AGENDA","ALLIED","ANIMAL","ANNUAL","APPEAL","ARRIVE","ARTIST","ASSUME",
    "ATTACK","AUTHOR",
    "BATTLE","BEAUTY","BECOME","BEFORE","BEHIND","BELONG","BETTER","BEYOND","BISHOP",
    "BITTER","BLANCH","BREACH","BRIDGE","BRIGHT","BROKEN","BRONZE","BUBBLE","BUDGET",
    "BUNDLE","BURDEN","BUREAU","BUTTER",
    "CAMERA","CANCEL","CARBON","CASTLE","CAUGHT","CENTER","CHANCE","CHANGE","CHARGE",
    "CHOSEN","CHURCH","CIRCLE","CLEVER","CLIENT","CLIQUE","CLOSET","COFFEE","COLUMN",
    "COMBAT","COMMON","CONVEY","COOKIE","CORNER","COSTLY","COTTON","COUPLE","COURSE",
    "COUSIN","CREATE","CREDIT","CRISIS","CUSTOM",
    "DAMAGE","DANGER","DEBATE","DECENT","DEFEAT","DEFEND","DEFINE","DEGREE","DEMAND",
    "DEPEND","DESERT","DESIGN","DESIRE","DETAIL","DETECT","DEVICE","DIFFER","DINNER",
    "DIRECT","DOCTOR","DOLLAR","DOMAIN","DOUBLE","DOZENS","DRIVEN","DRIVER","DURING",
    "EASILY","EFFECT","EFFORT","EIGHTH","EMPIRE","ENABLE","ENDURE","ENERGY","ENGINE",
    "ENOUGH","ENSURE","ENTIRE","EQUITY","ESCAPE","ESTATE","ETHNIC","EVOLVE","EXCEED",
    "EXCEPT","EXCUSE","EXPAND","EXPECT","EXPERT","EXPORT","EXPOSE","EXTEND","EXTENT",
    "FABRIC","FACTOR","FAILED","FAIRLY","FAMILY","FARMER","FATHER","FELINE","FELLOW",
    "FEMALE","FIERCE","FIGURE","FILTER","FINGER","FINISH","FLOWER","FLYING","FOLLOW",
    "FORBID","FORCED","FOREST","FORGET","FORMAL","FORMAT","FORMER","FOSSIL","FOURTH",
    "FREEZE","FRIEND","FROZEN","FUTURE",
    "GALAXY","GARDEN","GATHER","GENDER","GENTLE","GIGGLE","GIVING","GLOBAL","GOLDEN",
    "GOVERN","GROUND","GROWTH","GUITAR",
    "HANDLE","HAPPEN","HARDLY","HAZARD","HEALTH","HEAVEN","HEREBY","HEROIC","HIDDEN",
    "HIGHLY","HONEST","HUNGER","HUNTER",
    "IGNORE","IMMUNE","IMPACT","IMPORT","IMPOSE","INCOME","INDEED","INDOOR","INFANT",
    "INFORM","INJURY","INSECT","INSERT","INSIDE","INSIST","INTEND","INTENT","INVEST",
    "ISLAND","ITSELF",
    "JACKET","JERSEY","JUNGLE","JUNIOR","KIDNEY","KNIGHT","LAUNCH","LAWYER","LAYOUT",
    "LEADER","LEAGUE","LEGEND","LENGTH","LESSON","LETTER","LIKELY","LINEAR","LINGER",
    "LIQUID","LISTEN","LITTLE","LIVING","LONGER","LOVELY","LUXURY",
    "MAINLY","MANAGE","MANNER","MANUAL","MARGIN","MARINE","MARKER","MARKET","MASTER",
    "MATTER","MEDIUM","MEMBER","MEMORY","MENTAL","MENTOR","MERELY","METHOD","MIDDLE",
    "MIGHTY","MILLER","MINUTE","MIRROR","MOBILE","MODEST","MOMENT","MONKEY","MORTAL",
    "MOSTLY","MOTHER","MOTION","MURDER","MUSEUM","MUTUAL","MYSELF",
    "NARROW","NATION","NATURE","NEARLY","NICKEL","NIMBLE","NORMAL","NOTING","NOTION",
    "NOVICE","NUMBER","OBJECT","OBTAIN","OCCUPY","OFFEND","OFFSET","ONLINE","OPTION",
    "ORANGE","ORIENT","ORIGIN","OUTPUT",
    "PALACE","PARENT","PARTLY","PATENT","PATRON","PAUSE","PEBBLE","PENCIL","PEOPLE",
    "PERMIT","PERSON","PHRASE","PICKLE","PILLAR","PIRATE","PLANET","PLAYER","PLEASE",
    "PLEDGE","PLENTY","PLUNGE","POCKET","POETRY","POISON","POLICE","POLICY","POLISH",
    "POLITE","PORTAL","POSTER","POTATO","POWDER","PRAYER","PREFER","PRINCE","PRISON",
    "PROFIT","PROPER","PUNISH","PURPLE","PURSUE","PUZZLE",
    "RABBIT","RANDOM","RANGER","RATHER","RATING","READER","REASON","RECALL","RECENT",
    "RECORD","REDUCE","REFORM","REGARD","REGIME","REGION","REJECT","RELATE","RELIEF",
    "REMAIN","REMEDY","REMIND","REMOTE","REMOVE","RENDER","RENEW","RENTAL","REPAIR",
    "REPEAT","REPORT","RESCUE","RESIGN","RESIST","RESORT","RESULT","RETAIN","RETIRE",
    "RETURN","REVEAL","REVIEW","REVOLT","REWARD","RITUAL","ROBUST","ROCKET","ROTATE",
    "RUBBER","RULING","RUNNER",
    "SAFELY","SALMON","SAMPLE","SAVING","SCHEME","SCHOOL","SCREEN","SCRIPT","SEARCH",
    "SEASON","SECOND","SECRET","SECURE","SELECT","SERIES","SETTLE","SEVERE","SHADOW",
    "SHIELD","SIGNAL","SILENT","SILVER","SIMPLE","SINGER","SINGLE","SISTER","SLIGHT",
    "SMOOTH","SOCIAL","SOLELY","SOLVED","SOUGHT","SOURCE","SPEECH","SPHERE","SPIDER",
    "SPIRIT","SPREAD","SPRING","SQUARE","STABLE","STANCE","STATUE","STATUS","STEADY",
    "STOLEN","STRAIN","STRAND","STREAM","STREET","STRESS","STRICT","STRIKE","STRING",
    "STROKE","STRONG","STRUCK","STUDIO","SUBMIT","SUDDEN","SUFFER","SUMMER","SUMMIT",
    "SUNSET","SUPPLY","SURVEY","SWITCH","SYMBOL","SYSTEM",
    "TACKLE","TALENT","TARGET","TEMPLE","TENANT","TENDER","TERROR","THANKS","THEORY",
    "THIRTY","THIRST","THORNY","THREAD","THREAT","THRILL","THRIVE","THRONE","TIMBER",
    "TISSUE","TONGUE","TOWARD","TRAVEL","TREATY","TRIPLE","TROPHY","TUNNEL","TWELVE",
    "UNFAIR","UNIQUE","UNLIKE","UNREST","UPDATE","UPHOLD","UPWARD","URGENT",
    "VACUUM","VALLEY","VARIED","VENDOR","VERBAL","VERSUS","VESSEL","VIEWER","VIRGIN",
    "VISION","VOLUME",
    "WALKER","WEALTH","WEAPON","WEEKLY","WEIGHT","WINDOW","WINNER","WINTER","WISDOM",
